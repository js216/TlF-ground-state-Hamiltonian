...
\begin{tikzpicture}[scale=8]
   ...
   \draw (\xf-\len-0.5*\lenmark-\xoffset, \yB-.217455) node[anchor=east,left] {-217.455}
      -- (\xf-\len+0.5*\lenmark-\xoffset,\yB-.217455) node[right,below,xshift=-\pos] {$F=1$};
   \draw (\xf-\len-0.5*\lenmark-\xoffset, \yB-.172936) node[anchor=east,left] {-172.936}
      -- (\xf-\len+0.5*\lenmark-\xoffset,\yB-.172936) node[right,above,xshift=-\pos] {$F=2$};
   \draw (\xf-\len-0.5*\lenmark-\xoffset, \yB+.105876) node[anchor=east,left] {105.876}
      -- (\xf-\len+0.5*\lenmark-\xoffset,\yB+.105876) node[right,below,xshift=-\pos] {$F=2$};
   \draw (\xf-\len-0.5*\lenmark-\xoffset, \yB+.141095) node[anchor=east,left] {141.095}
...
\caption{TlF ground state zero-field energy levels. NB: Rotational energies
$BJ(J+1)$ are subtracted from the energies indicated on the axis.}
